...
public class GameDAO {
    ...
    public void updateGame(UserGame game) throws DataAccessException{
        ...
        try{
            ...
            statement.setString(3, gson.toJson(game.getGame()));//FIXME
    ...
    private UserGame parseSet(ResultSet set) throws SQLException{
        ...
        builder.registerTypeAdapter(ChessMove.class, new model.Deserializer());
        builder.registerTypeAdapter(ChessPosition.class, new model.Deserializer());
        game.updateGame(builder.create().fromJson(json, GameImpl.class));
        return game;
    }
    ...
    private void add(UserGame game, Connection conn) throws DataAccessException{
        ...
        try{
            ...
            statement.setString(2, gson.toJson(game.getGame())); //FIXME game object
            statement.executeUpdate();
        }
        catch (SQLException err){
            db.rollback(conn);
